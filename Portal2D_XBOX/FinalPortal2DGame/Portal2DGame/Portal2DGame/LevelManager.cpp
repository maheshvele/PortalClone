...
FILE *GetLevelFilePtr(int level)
{
	...
	{
	case 1:
		strcpy(fileName, "D:\\Levels\\level_01.txt");
		break;
	case 2:
		strcpy(fileName, "D:\\Levels\\level_02.txt");
		break;
	case 3:
		strcpy(fileName, "D:\\Levels\\level_03.txt");
		break;
	case 4:
		strcpy(fileName, "D:\\Levels\\level_04.txt");
		break;
	case 5:
		strcpy(fileName, "D:\\Levels\\level_05.txt");
		break;
	case 6:
		strcpy(fileName, "D:\\Levels\\level_06.txt");
		break;
	case 7:
		strcpy(fileName, "D:\\Levels\\level_07.txt");
		break;
	case 8:
		strcpy(fileName, "D:\\Levels\\level_08.txt");
		break;
	case 9:
		strcpy(fileName, "D:\\Levels\\level_09.txt");
		break;
	case 10:
		strcpy(fileName, "D:\\Levels\\level_10.txt");
		break;
	}
	levelDataPtr = fopen(fileName, "r");
...
void FillLevelData(char *line, LevelDataStr *currentLevelData)
{
	...
	if (strcmp(word, "SL") == 0)
	{
		...
		while (word != NULL)
		{
			word = strtok(NULL, " ");
			if (word)
				data[i++] = (float)strtod(word, &endPtr);
		}
		Line staticLine;
