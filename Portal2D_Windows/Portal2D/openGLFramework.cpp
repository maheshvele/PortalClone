...
float gl_mouse_x, gl_mouse_y;												// openGL world mouse Position
...
void ReshapeGL (int width, int height)									// Reshape The Window When It's Moved Or Resized
{
	...
	glOrtho(0.0, SCREEN_SIZE_X, SCREEN_SIZE_Y, 0.0, -1, 1);
...
LRESULT CALLBACK WindowProc (HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	switch (uMsg)														// Evaluate Window Message
	{
		...
		case WM_RBUTTONDOWN:
		{
			...
			window->keys->keyDown[VK_RBUTTON] = TRUE;
		}
		break;
		...
		case WM_RBUTTONUP:
		{
			...
			window->keys->keyDown[VK_RBUTTON] = FALSE;
		}
		break;
		...
		case WM_LBUTTONDOWN:
		{
			...
			window->keys->keyDown[VK_LBUTTON] = TRUE;
		}
		break;
		...
		case WM_LBUTTONUP:
		{
			...
			window->keys->keyDown[VK_LBUTTON] = FALSE;
		}
		break;
